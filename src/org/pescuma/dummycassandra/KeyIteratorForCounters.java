 ...
 */
class KeyIteratorForCounters<K> implements Iterable<K>
{
	...
	public KeyIteratorForCounters(Keyspace keyspace, String columnFamily, AbstractSerializer<K> serializer)
	{
	...
	public KeyIteratorForCounters(Keyspace keyspace, String columnFamily, AbstractSerializer<K> serializer, K start,
			K end)
	{
	...
	public KeyIteratorForCounters(Keyspace keyspace, String columnFamily, AbstractSerializer<K> serializer, K start,
			K end, int maxRowCount)
	{
		query = HFactory.createRangeSlicesCounterQuery(keyspace, serializer, stringSerializer) //
