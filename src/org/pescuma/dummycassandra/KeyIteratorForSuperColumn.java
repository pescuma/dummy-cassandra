 ...
 */
class KeyIteratorForSuperColumn<K> implements Iterable<K>
{
	...
	public KeyIteratorForSuperColumn(Keyspace keyspace, String columnFamily, AbstractSerializer<K> serializer)
	{
	...
	public KeyIteratorForSuperColumn(Keyspace keyspace, String columnFamily, AbstractSerializer<K> serializer, K start,
			K end)
	{
