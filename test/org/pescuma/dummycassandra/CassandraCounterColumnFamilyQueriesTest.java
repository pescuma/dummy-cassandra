...
public class CassandraCounterColumnFamilyQueriesTest
{
	...
	public void setUp()
	{
		...
		cf = keyspace.addColumnFamily("cf", CassandraType.UTF8, CassandraType.UTF8, CassandraType.Counter);
		cluster.connect();
	}
	...
	public void testGetColumnNamesSimple()
	{
		...
		for (int i = 0; i < 10; i++)
			row.incrementCounter(String.format("a%03d", i), i);
	...
	public void testGetColumnNamesRangeAll()
	{
		...
		for (int i = 0; i < 10; i++)
			row.incrementCounter(String.format("b%03d", i), i);
	...
	public void testGetColumnNamesRangeSmall()
	{
		...
		for (int i = 0; i < 100; i++)
			row.incrementCounter(String.format("a%03d", i), 1);
